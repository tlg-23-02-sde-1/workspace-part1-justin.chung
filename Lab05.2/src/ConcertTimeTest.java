...
class ConcertTimeTest {
    ...
    public static void testLiveConcert() {
        ...
        LocalDateTime concertDateTime = LocalDateTime.of(concertDate, concertTime);
        ZonedDateTime concertZonedDateTime = ZonedDateTime.of(concertDateTime, ZoneId.of("America/Toronto"));
        ZonedDateTime concertZonedDateTimeInPerth = concertZonedDateTime.withZoneSameInstant(ZoneId.of("Australia/Perth"));
        System.out.println(concertZonedDateTimeInPerth);
    }
}