...
class DateTimeTest {
    ...
    public static void testCreate() {
        ...
        LocalDate bday = LocalDate.of(1991, 12, 5);
        System.out.println("I was born on a " + bday.getDayOfWeek());
        ...
        System.out.println("The moon landing was on " + moonLanding);
        System.out.println("The moon landing was on a " + moonLanding.getDayOfWeek());
    }
    ...
    public static void testParse() {
        ...
        LocalDate bday = LocalDate.parse("1991-12-05");
        System.out.println("I was born on a " + bday.getDayOfWeek());
        // OPTIONAL: now create it by parsing text in the form "2/6/2014" (this is Feb 6, not Jun 2).
        LocalDate bday2 = LocalDate.parse("12/05/1991", DateTimeFormatter.ofPattern("MM/dd/yyyy"));
        System.out.println("I was born on a " + bday2.getDayOfWeek());
    }
    ...
    public static void testFormat() {
        ...
        // TODO: 10/14/1066
        System.out.println("The battle of Hastings was on " + hastings.format(DateTimeFormatter.ofPattern("MM/dd/yyyy")));

        // TODO: 14-10-1066
        System.out.println("The battle of Hastings was on " + hastings.format(DateTimeFormatter.ofPattern("dd-MM-yyyy")));

        // OPTIONAL: October 14, 1066
        System.out.println("The battle of Hastings was on " + hastings.format(DateTimeFormatter.ofPattern("MMMM dd, yyyy")));
    }
}